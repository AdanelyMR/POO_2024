...
class Coches:
    ...
    #El encapsulamiento en python tambien es llamado visibilidad y practicamente se puede hacer queun atributo y/o un metodo sea publicos o privados 
    ...
    #Para usar un atributo privado es necesario hacerlo a traves de un metodo publico 
